...
export function HeroVideoDialog({
  ...
  const videoId = isYouTube ? getYouTubeId(videoSrc) : null;
    ...
    <div className={cn("relative", className)}>
      ...
      >
        <Image
          ...
          width={1920}
          height={1080}
          className="w-full h-auto rounded-md border shadow-lg transition-all duration-200 ease-out group-hover:brightness-[0.8]"
        />
